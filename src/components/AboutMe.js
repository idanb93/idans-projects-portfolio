    ...
    return (
        <div id='about-me'>
            ...
            <div id='about-me-body'>
                <h3>Full Stack Developer experienced in JavaScript and Python based programming with a background in Machine Learning.</h3>
                ...
                <h3>I have rich experience with a variety of programming languages ​​and frameworks, development of E2E features from scratch on both server side and client side. </h3>
